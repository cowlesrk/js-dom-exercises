...
// A delegated click event listener has been attached to the selected ul element, 
// which is stored in the variable list. The handler is targeting each button in the list. 
// When any one of the buttons is clicked, a class of highlight should be added to 
// the paragraph element immediately preceding that button inside the parent list item element. 
...
// Added function to create buttons
// ------------------------------------------------------------------------
